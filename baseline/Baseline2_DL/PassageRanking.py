...
def TrainAndValidate(trainfile):
    ...
    num_classes = 2
    minibatch_size = 250
    epoch_size = 10000 #No.of samples in training set
    ...
    save_step=5 #save model every k epochs

    print("Train and validate function")
    ...
    print("Created placeholders for reading training data")
...
if __name__ == "__main__":
    ...
    # trainSetFileName = "ValidationData.ctf"    
