...
if __name__ == "__main__":
    ...
    dataset_path= "../../data/filtered/BM25_filtered_data_1m.tsv"
    # dataset_path= "../../data/data.tsv"
    
    trainFileName = "train.tsv"
    validationFileName = "test.tsv"
    EvaluationFileName = "../../data/eval1_unlabelled.tsv"

    embeddingFileName = "../../data/embeddings/glove.6B/glove.6B.50d.txt"

    split_tsv(dataset_path,trainFileName,validationFileName,split=0.8)
